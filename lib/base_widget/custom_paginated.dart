...
class CustomPaginated extends StatefulWidget {
  ...
  /// particular [CustomPaginated] widget is created; avoid creating a new
  /// [DataTableSource] with each new instance of the [CustomPaginated]
  ...
  /// To modify the border or background color of the [CustomPaginated], use
  ...
  /// [CustomPaginated] widget itself; it should be reused each time the
  /// [CustomPaginated] constructor is called.
  ...
  @override
  CustomPaginatedState createState() => CustomPaginatedState();
}

/// Holds the state of a [CustomPaginated].
///
/// The table can be programmatically paged using the [pageTo] method.
class CustomPaginatedState extends State<CustomPaginated> {
  ...
  @override
  void didUpdateWidget(CustomPaginated oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final actualFixedRows = math.max(
        0, _rows.isEmpty ? 0 : math.min(fixedTopRows, _rows.length + 1));
